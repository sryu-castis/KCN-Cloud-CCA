define(["framework/Drawer", "cca/PopupValues"], function (Drawer, PopupValues) {
    var DialogPopupDrawer = function (_id, _model) {
        ...
        this.templateList = {'layout': new EJS({url: 'js/ui/popupViewGroup/dialogPopupView/LayoutTemplate.ejs'})
                            , 'layout_xlarge': new EJS({url: 'js/ui/popupViewGroup/dialogPopupView/LayoutXLargeTemplate.ejs'})
                            , 'layout_large03': new EJS({url: 'js/ui/popupViewGroup/dialogPopupView/LayoutLarge03Template.ejs'})};
        var _this = this;
        ...
        DialogPopupDrawer.prototype.onPaint = function () {
            var result = null;
            if(this.model.getParam().popupType == PopupValues.PopupType.DIALOG_XLARGE) {
                result = _this.templateList['layout_xlarge'].render({model: this.model});
            } else if(this.model.getParam().popupType == PopupValues.PopupType.DIALOG_LARGE_03) {
