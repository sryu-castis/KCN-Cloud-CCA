define(["framework/Drawer", "ui/purchaseViewGroup/purchaseMonthlyCouponConfirmView/PurchaseMonthlyCouponConfirmModel", "helper/UIHelper"], function (Drawer, PurchaseMonthlyCouponConfirmModel, UIHelper) {
    var PurchaseMonthlyCouponConfirmDrawer = function (_id, _model) {
        Drawer.call(this, _id, _model);
        this.templateList = {'layout': new EJS({url: 'js/ui/purchaseViewGroup/purchaseMonthlyCouponConfirmView/LayoutTemplate.ejs'})};
        var _this = this;
        var marqueeText = null;

        PurchaseMonthlyCouponConfirmDrawer.prototype.onCreateLayout = function () {
            //@같은 컨테이너를 공유하도록 처리
            this.createContainer("purchasePopup");
        };

        PurchaseMonthlyCouponConfirmDrawer.prototype.onPaint = function () {
        	var result = _this.templateList['layout'].render({model: this.model, 'UIHelper':UIHelper});
			this.getContainer().html(result);
			setButtonElement();
        };
        
        PurchaseMonthlyCouponConfirmDrawer.prototype.onAfterPaint = function () {
        ...
        function getFocusIndexItem() {
            ...
            var listItems = $("#popup_xlarge .coupon_bg02");
...
//            var listItems = $('#purchasePopup #popup_xlarge .bt_147');
//            var focusItem = listItems.eq(focusIndex);
//            focusItem.addClass("focus");
//        }
//
...
//        PurchaseMonthlyCouponConfirmDrawer.prototype.onDestroy = function ()	{
//        	this.getContainer().hide();
//        }
    };
    PurchaseMonthlyCouponConfirmDrawer.prototype = Object.create(Drawer.prototype);


    return PurchaseMonthlyCouponConfirmDrawer;
});
